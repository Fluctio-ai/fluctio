...
export function AppSidebar(props: React.ComponentProps<typeof Sidebar>) {
  ...
  // name instead of falling back to "Fluctio". The single-agent
  ...
  // broadcasts a `fluctio:sessions-changed` event (e.g. after rename /
  ...
  React.useEffect(() => {
    ...
    window.addEventListener("fluctio:sessions-changed", onChange);
    return () => {
      window.removeEventListener("fluctio:sessions-changed", onChange);
    };
  }, [activeAgentId]);
