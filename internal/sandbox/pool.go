...
// the global $FLUCTIO_HOME/skills/ tree or this agent's private
// $FLUCTIO_HOME/agents/<agentID>/agent/skills/. Without the per-agent
...
//
// home is the resolved FLUCTIO_HOME (the pool's workspaceRoot), not
