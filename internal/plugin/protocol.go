...
const (
	...
	// MethodChatSend: plugin → fluctio notification that delivers a
...
// must not cache credentials — Fluctio re-sends them every call so any
...
// ChatSendParams: plugin → fluctio push of an outbound message to a
