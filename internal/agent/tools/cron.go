		...
		map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"silent": map[string]interface{}{
					"type":        "boolean",
					"description": "DEFAULT FALSE. Only set true when the user explicitly wants a background task that must NOT notify anyone (no reply sent to any chat). If the user wants the result sent/told/notified/reminded to them, this MUST be false. Mutually exclusive with targeting another channel.",
				},
			},
