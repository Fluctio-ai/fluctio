...
克制、安静、工具感。Geist 血统：浅色纯中性灰阶，暗色「深水」微冷青染；单一涌流青（surge cyan）色轴（浅 #0e7490 / 暗 #22d3ee，源自 fluctus=波浪的品牌语义），三档圆角家族（6/12/16px），信息密度优先，动效少而快。
...
2. **单一青色轴**：涌流青只用于主操作/焦点/品牌；状态色仅表状态。
