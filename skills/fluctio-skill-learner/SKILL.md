---
name: fluctio-skill-learner
description: Analyze conversations to extract reusable skill patterns. Used internally by Fluctio to auto-generate skills from complex multi-step tasks.
metadata:
  fluctio:
    always: true
---
